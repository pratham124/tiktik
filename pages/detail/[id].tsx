...
const Detail = ({ postDetails }: Iprops) => {
  ...
  const onLikeHandler = async (like: boolean) => {
    if (userProfile) {
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="Post"
          content="Post page where users are able to like or comment on the post"
        />
          ...
          <div className="lg:mt-20 mt-10">
            ...
            <div className="mt-10 px-10 mb-5">
              {userProfile && (
                <LikeButton
                  likes={post.likes}
                  onLikeHandler={() => onLikeHandler(true)}
                  onDislikeHandler={() => onLikeHandler(false)}
                />
              )}
            </div>
            <div>
